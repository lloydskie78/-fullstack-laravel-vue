...
<script>
    export default {
        ...
        created(){
            ...
            //get the blog posts
            let posts = [
                    {title: 'This is a title 1', 'post' : 'this is the blog post 1', id: 1},
                    {title: 'This is a title 2', 'post' : 'this is the blog post 2', id: 2},
                    {title: 'This is a title 3', 'post' : 'this is the blog post 3', id: 3},
                    {title: 'This is a title 4 ', 'post' : 'this is the blog post 4', id: 4},
                ]
            this.blogs = posts
        }
    }
